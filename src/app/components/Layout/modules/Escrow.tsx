...
const Escrow: FunctionComponent<EscrowProps> = ({
  ...
  return (
    <div className="flex flex-col border border-black">
      ...
      >
        {(activeTab === "all" ? physicalEscrowedLoading : physicalUserEscrowedLoading) && (activeTab === "all" ? physicalRightsEscrowed : physicalRightsUserEscrowed)?.length === 0 ? (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {(() => {
                      const canDeposit = (activeTab === "my" && Number(right.guaranteedAmount) > 0) || 
                        (activeTab === "all" && address && right.originalBuyer?.toLowerCase() === address.toLowerCase() && Number(right.guaranteedAmount) > 0);
        ...
        {(activeTab === "all" ? physicalRightsEscrowed : physicalRightsUserEscrowed)?.length === 0 &&
